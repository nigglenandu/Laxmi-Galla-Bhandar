...
public class CustomerServiceImpl implements ICustomerService {
    ...
    @Override
    public PageResponse<CustomerResponseDto> getAllCustomers(CustomerSearchCriteria criteria, Pageable pageable) {
    ...
    public CustomerResponseDto updateCustomer(Long id, CustomerRequestDto dto) {
        ...
        eventPublisher.publishEvent(CustomerUpdatedEvent.of(updated.getId().toString(), correlationId));
    ...
    private CustomerEntity getCustomerOrThrow(Long id) {
        return customerRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Customer", id.toString()));
    }
    ...
    private void validatePanUniqueness(CustomerEntity existing, CustomerRequestDto dto) {
        ...
        boolean exists = customerRepository.existsByPanNumberAndIdNot(newPan, existing.getId());

        if (exists) {
            throw new DuplicateResourceException("Customer", "panNumber", dto.panNumber());
        }
    }


    @Override
    public void performAccountAction(Long customerId, AccountAction action, String reason) {
